		...
		<div class="cta_columns">
			...
			<div class="one cta_columns_single">
				...
				<?php if($textButton1 || is_customize_preview()): ?>
					<div class="freddoButton cta"><a href="<?php echo esc_url($linkButton1); ?>"><h4><?php echo esc_html($textButton1); ?></h4></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
			...
			<div class="two cta_columns_single">
				...
				<?php if($textButton2 || is_customize_preview()): ?>
					<div class="freddoButton cta"><a href="<?php echo esc_url($linkButton2); ?>"><h4><?php echo esc_html($textButton2); ?></h4></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
			...
			<div class="three cta_columns_single">
				...
				<?php if($textButton3 || is_customize_preview()): ?>
					<div class="freddoButton cta"><a href="<?php echo esc_url($linkButton3); ?>"><h4><?php echo esc_html($textButton3); ?></h4></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
			...
			<div class="four cta_columns_single">
				...
				<?php if($textButton4 || is_customize_preview()): ?>
					<div class="freddoButton cta"><a href="<?php echo esc_url($linkButton4); ?>"><h4><?php echo esc_html($textButton4); ?></h4></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
			...
			<div class="four cta_columns_single">
				...
				<?php if($textButton5 || is_customize_preview()): ?>
					<div class="freddoButton cta"><a href="<?php echo esc_url($linkButton5); ?>"><h4><?php echo esc_html($textButton5); ?></h4></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
			...
			<div class="four cta_columns_single">
				...
				<?php if($textButton6 || is_customize_preview()): ?>
					<div class="freddoButton cta"><a href="<?php echo esc_url($linkButton6); ?>"><h4><?php echo esc_html($textButton6); ?></h4></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
			<?php if ($howManyBoxes == 7): ?>
			<?php
				$fontAwesomeIcon1 = freddo_options('_onepage_fontawesome_1_cta', 'fa fa-bell');
				$choosePageBox1 = freddo_options('_onepage_choosepage_1_cta');
				$textButton1 = freddo_options('_onepage_boxtextbutton_1_cta', __('More Information', 'freddo'));
				...
				$textButton6 = freddo_options('_onepage_boxtextbutton_6_cta', __('More Information', 'freddo'));
				$linkButton6 = freddo_options('_onepage_boxlinkbutton_6_cta', '#');						
				$fontAwesomeIcon7 = freddo_options('_onepage_fontawesome_7_cta', 'fa fa-bell');
				$choosePageBox7 = freddo_options('_onepage_choosepage_7_cta');
				$textButton7 = freddo_options('_onepage_boxtextbutton_7_cta', __('More Information', 'freddo'));
				$linkButton7 = freddo_options('_onepage_boxlinkbutton_7_cta', '#');				
			?>
			<div class="four cta_columns_single">
				<?php if($fontAwesomeIcon1): ?>
					<div class="ctaIcon"><i class="<?php echo esc_attr($fontAwesomeIcon1); ?>" aria-hidden="true"></i></div>
			...
			<div class="four cta_columns_single">
				<?php if($fontAwesomeIcon7): ?>
					<div class="ctaIcon"><i class="<?php echo esc_attr($fontAwesomeIcon7); ?>" aria-hidden="true"></i></div>
				<?php endif; ?>
				<?php if($choosePageBox7): ?>
					<h3><?php echo get_the_title(intval($choosePageBox7)); ?></h3>
					<?php
					$post_content7 = get_post(intval($choosePageBox7));
					$content7 = $post_content7->post_content;
					?>
					<p><?php echo wp_trim_words($content7 , intval($textLenght), esc_html($customMore) ); ?></p>
				<?php endif; ?>
				<?php if($textButton7 || is_customize_preview()): ?>
					<div class="freddoButton cta"><a href="<?php echo esc_url($linkButton7); ?>"><h4><?php echo esc_html($textButton7); ?></h4></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
			<?php if ($howManyBoxes == 8): ?>
			<?php
				$fontAwesomeIcon1 = freddo_options('_onepage_fontawesome_1_cta', 'fa fa-bell');
				$choosePageBox1 = freddo_options('_onepage_choosepage_1_cta');
				$textButton1 = freddo_options('_onepage_boxtextbutton_1_cta', __('More Information', 'freddo'));
				...
				$textButton7 = freddo_options('_onepage_boxtextbutton_7_cta', __('More Information', 'freddo'));
				$linkButton7 = freddo_options('_onepage_boxlinkbutton_7_cta', '#');						
				$fontAwesomeIcon8 = freddo_options('_onepage_fontawesome_8_cta', 'fa fa-bell');
				$choosePageBox8 = freddo_options('_onepage_choosepage_8_cta');
				$textButton8 = freddo_options('_onepage_boxtextbutton_8_cta', __('More Information', 'freddo'));
				$linkButton8 = freddo_options('_onepage_boxlinkbutton_8_cta', '#');				
			?>
			<div class="four cta_columns_single">
				<?php if($fontAwesomeIcon1): ?>
					<div class="ctaIcon"><i class="<?php echo esc_attr($fontAwesomeIcon1); ?>" aria-hidden="true"></i></div>
			...
			<div class="four cta_columns_single">
				<?php if($fontAwesomeIcon8): ?>
					<div class="ctaIcon"><i class="<?php echo esc_attr($fontAwesomeIcon8); ?>" aria-hidden="true"></i></div>
				<?php endif; ?>
				<?php if($choosePageBox8): ?>
					<h3><?php echo get_the_title(intval($choosePageBox8)); ?></h3>
					<?php
					$post_content8 = get_post(intval($choosePageBox8));
					$content8 = $post_content8->post_content;
					?>
					<p><?php echo wp_trim_words($content8 , intval($textLenght), esc_html($customMore) ); ?></p>
				<?php endif; ?>
				<?php if($textButton8 || is_customize_preview()): ?>
					<div class="freddoButton cta"><a href="<?php echo esc_url($linkButton8); ?>"><h4><?php echo esc_html($textButton8); ?></h4></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
		</div>
