						...
						<ul>
							<li>
								...
								<div class="freddoDocImage">
									<iframe width="560" height="315" src="https://www.youtube.com/embed/xyF4ZcvfeUk" frameborder="0" allowfullscreen></iframe>
								</div>
							</li>
							<li>
								<div class="freddoDocText">
					...
					<div class="toggleText">
						<ul>
							<li>
								...
								<div class="freddoDocImage">
									<iframe width="560" height="315" src="https://www.youtube.com/embed/e-DStW28su0" frameborder="0" allowfullscreen></iframe>
								</div>
							</li>
							<li>
								<div class="freddoDocText">
